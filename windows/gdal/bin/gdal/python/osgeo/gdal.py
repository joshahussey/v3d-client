...
def wrapper_EscapeString(*args, **kwargs):
  """wrapper_EscapeString(int len, int scheme = CPLES_SQL) -> retStringAndCPLFree"""
  return _gdal.wrapper_EscapeString(*args, **kwargs)

def EscapeBinary(*args, **kwargs):
  """EscapeBinary(int len, int scheme = CPLES_SQL)"""
  return _gdal.EscapeBinary(*args, **kwargs)
...
class DirEntry(_object):
    ...
    if _newclass:name = _swig_property(_gdal.DirEntry_name_get)
    __swig_getmethods__["mode"] = _gdal.DirEntry_mode_get
    if _newclass:mode = _swig_property(_gdal.DirEntry_mode_get)
    __swig_getmethods__["size"] = _gdal.DirEntry_size_get
    if _newclass:size = _swig_property(_gdal.DirEntry_size_get)
    __swig_getmethods__["mtime"] = _gdal.DirEntry_mtime_get
    if _newclass:mtime = _swig_property(_gdal.DirEntry_mtime_get)
    __swig_getmethods__["modeKnown"] = _gdal.DirEntry_modeKnown_get
    if _newclass:modeKnown = _swig_property(_gdal.DirEntry_modeKnown_get)
    __swig_getmethods__["sizeKnown"] = _gdal.DirEntry_sizeKnown_get
    if _newclass:sizeKnown = _swig_property(_gdal.DirEntry_sizeKnown_get)
    __swig_getmethods__["mtimeKnown"] = _gdal.DirEntry_mtimeKnown_get
    if _newclass:mtimeKnown = _swig_property(_gdal.DirEntry_mtimeKnown_get)
    __swig_getmethods__["extra"] = _gdal.DirEntry_extra_get
    if _newclass:extra = _swig_property(_gdal.DirEntry_extra_get)
...
def SetThreadLocalConfigOption(*args):
  """SetThreadLocalConfigOption(char pszKey, char pszValue)"""
...
def GetThreadLocalConfigOption(*args):
  """GetThreadLocalConfigOption(char pszKey, char pszDefault = None) -> char"""
  return _gdal.GetThreadLocalConfigOption(*args)

def SetCredential(*args):
  """SetCredential(char pszPathPrefix, char pszKey, char pszValue)"""
  return _gdal.SetCredential(*args)

def GetCredential(*args):
  """GetCredential(char pszPathPrefix, char pszKey, char pszDefault = None) -> char"""
  return _gdal.GetCredential(*args)

def ClearCredentials(*args):
  """ClearCredentials(char pszPathPrefix = None)"""
...
def AbortPendingUploads(*args):
  """AbortPendingUploads(char utf8_path) -> bool"""
...
def VSIFOpenExL(*args):
  """
    VSIFOpenExL(char utf8_path, char pszMode, int bSetError = True, 
        char options = None) -> VSILFILE
    """
...
class Dataset(MajorObject):
    ...
    def SetSpatialRef(self, *args):
        """SetSpatialRef(self, SpatialReference srs) -> CPLErr"""
    ...
    def IsLayerPrivate(self, *args):
        """IsLayerPrivate(self, int index) -> bool"""
    ...
    def ReadRaster1(self, *args, **kwargs):
        ...
        ReadRaster1(self, double xoff, double yoff, double xsize, double ysize, 
            ...
            GDALProgressFunc callback = 0, 
            void callback_data = None, void inputOutputBuf = None) -> CPLErr
        """
...
class Group(_object):
    ...
    def GetVectorLayerNames(self, *args):
        """GetVectorLayerNames(self, char options = None) -> char"""
        return _gdal.Group_GetVectorLayerNames(self, *args)

    def OpenVectorLayer(self, *args):
        """OpenVectorLayer(self, char name, char options = None) -> Layer"""
...
class Statistics(_object):
    ...
    if _newclass:min = _swig_property(_gdal.Statistics_min_get)
    __swig_getmethods__["max"] = _gdal.Statistics_max_get
    if _newclass:max = _swig_property(_gdal.Statistics_max_get)
    __swig_getmethods__["mean"] = _gdal.Statistics_mean_get
    if _newclass:mean = _swig_property(_gdal.Statistics_mean_get)
    __swig_getmethods__["std_dev"] = _gdal.Statistics_std_dev_get
    if _newclass:std_dev = _swig_property(_gdal.Statistics_std_dev_get)
    __swig_getmethods__["valid_count"] = _gdal.Statistics_valid_count_get
    if _newclass:valid_count = _swig_property(_gdal.Statistics_valid_count_get)
...
class MDArray(_object):
    ...
    def AdviseRead(self, *args):
        """AdviseRead(self, int nDims1, int nDims2, char options = None) -> CPLErr"""
    ...
    def SetOffset(self, *args, **kwargs):
        """SetOffset(self, double val, GDALDataType storageType = GDT_Unknown) -> CPLErr"""
        return _gdal.MDArray_SetOffset(self, *args, **kwargs)

    def SetScale(self, *args, **kwargs):
        """SetScale(self, double val, GDALDataType storageType = GDT_Unknown) -> CPLErr"""
    ...
    def GetStatistics(self, *args, **kwargs):
        """
        GetStatistics(self, bool approx_ok = True, bool force = TRUE, GDALProgressFunc callback = 0, 
    ...
    def ComputeStatistics(self, *args, **kwargs):
        """
        ComputeStatistics(self, bool approx_ok = True, GDALProgressFunc callback = 0, 
            void callback_data = None) -> Statistics
        """
    ...
    def GetResampled(self, *args):
        """
        GetResampled(self, int nDimensions, GDALRIOResampleAlg resample_alg, SpatialReference srs, 
            char options = None) -> MDArray
        """
        return _gdal.MDArray_GetResampled(self, *args)

    def Cache(self, *args):
        """Cache(self, char options = None) -> bool"""
...
class ExtendedDataType(_object):
    ...
    def CreateString(*args):
        """CreateString(size_t nMaxStringLength = 0, ExtendedDataTypeSubType eSubType = GEDTST_NONE) -> ExtendedDataType"""
        return _gdal.ExtendedDataType_CreateString(*args)

    if _newclass:CreateString = staticmethod(CreateString)
    __swig_getmethods__["CreateString"] = lambda x: CreateString
    ...
    if _newclass:CreateCompound = staticmethod(CreateCompound)
    __swig_getmethods__["CreateCompound"] = lambda x: CreateCompound
    def GetName(self, *args):
        """GetName(self) -> char"""
    ...
    def GetSubType(self, *args):
        """GetSubType(self) -> ExtendedDataTypeSubType"""
...
def ExtendedDataType_CreateString(*args):
  """ExtendedDataType_CreateString(size_t nMaxStringLength = 0, ExtendedDataTypeSubType eSubType = GEDTST_NONE) -> ExtendedDataType"""
  return _gdal.ExtendedDataType_CreateString(*args)
...
class Band(MajorObject):
    ...
    def SetNoDataValueAsInt64(self, *args):
        """SetNoDataValueAsInt64(self, GIntBig v) -> CPLErr"""
        return _gdal.Band_SetNoDataValueAsInt64(self, *args)

    def SetNoDataValueAsUInt64(self, *args):
        """SetNoDataValueAsUInt64(self, GUIntBig v) -> CPLErr"""
    ...
    def WriteRaster(self, *args, **kwargs):
        ...
        WriteRaster(self, int xoff, int yoff, int xsize, int ysize, GIntBig buf_len, 
            int buf_xsize = None, int buf_ysize = None, 
            GDALDataType buf_type = None, GIntBig buf_pixel_space = None, 
    ...
    def ReadBlock(self, *args, **kwargs):
        """ReadBlock(self, int xoff, int yoff, void buf_obj = None) -> CPLErr"""
...
def _ApplyVerticalShiftGrid(*args, **kwargs):
  """
    _ApplyVerticalShiftGrid(Dataset src_ds, Dataset grid_ds, bool inverse = False, 
...
_ApplyVerticalShiftGrid = _gdal._ApplyVerticalShiftGrid
...
DataTypeUnion = _gdal.DataTypeUnion
