import { createEffect, createResource, createSignal, For, Signal, Suspense } from "solid-js";
...
export function LoadView() {
    ...
    const { setLoadOpened } = useToolbarStateContext() as any;
                        ...
                        <ul class="load-view-list cslt-list" ref={viewListRef}>
                            <For each={resource()}>
                                {view => (
                                    ...
                                    >
                                        <span class="load-view-entry-title">{view.title}</span>
                                        <p class="load-view-entry-description">{view.description}</p>
