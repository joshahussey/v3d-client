...
def AddNumpyArrayToDict(dict: 'PyObject *', schemaField: 'ArrowSchema const *', arrayField: 'ArrowArray const *', osPrefix: 'std::string const &', pointerArrayKeeper: 'PyObject *') -> "bool":
    """AddNumpyArrayToDict(PyObject * dict, ArrowSchema const * schemaField, ArrowArray const * arrayField, std::string const & osPrefix, PyObject * pointerArrayKeeper) -> bool"""
...
def _RecordBatchAsNumpy(recordBatchPtr: 'VoidPtrAsLong', schemaPtr: 'VoidPtrAsLong', pointerArrayKeeper: 'PyObject *') -> "PyObject *":
    """_RecordBatchAsNumpy(VoidPtrAsLong recordBatchPtr, VoidPtrAsLong schemaPtr, PyObject * pointerArrayKeeper) -> PyObject *"""
