...
def _UserHasSpecifiedIfUsingExceptions(*args) -> "int":
    """_UserHasSpecifiedIfUsingExceptions() -> int"""
...
def SetPathSpecificOption(*args) -> "void":
    """SetPathSpecificOption(char const * pszPathPrefix, char const * pszKey, char const * pszValue)"""
...
def GetCredential(*args) -> "char const *":
    """GetCredential(char const * pszPathPrefix, char const * pszKey, char const * pszDefault=None) -> char const *"""
    return _gdal.GetCredential(*args)

def GetPathSpecificOption(*args) -> "char const *":
    """GetPathSpecificOption(char const * pszPathPrefix, char const * pszKey, char const * pszDefault=None) -> char const *"""
...
def ClearPathSpecificOptions(*args) -> "void":
    """ClearPathSpecificOptions(char const * pszPathPrefix=None)"""
...
def FileFromMemBuffer(*args) -> "VSI_RETVAL":
    """FileFromMemBuffer(char const * utf8_path, GIntBig nBytes) -> VSI_RETVAL"""
...
def CopyFile(*args, **kwargs) -> "int":
    """CopyFile(char const * pszSource, char const * pszTarget, VSILFILE fpSource=None, GIntBig nSourceSize=-1, char ** options=None, GDALProgressFunc callback=0, void * callback_data=None) -> int"""
...
class Dataset(MajorObject):
    ...
    def BuildOverviews(self, *args, **kwargs) -> "int":
        """BuildOverviews(Dataset self, char const * resampling, int overviewlist=0, GDALProgressFunc callback=0, void * callback_data=None, char ** options=None) -> int"""
    ...
    def BeginAsyncReader(self, *args, **kwargs) -> "GDALAsyncReaderShadow *":
        """BeginAsyncReader(Dataset self, int xOff, int yOff, int xSize, int ySize, size_t buf_len, int buf_xsize, int buf_ysize, GDALDataType bufType, int band_list=0, int nPixelSpace=0, int nLineSpace=0, int nBandSpace=0, char ** options=None) -> AsyncReader"""
...
class Band(MajorObject):
    ...
    def _EnablePixelTypeSignedByteWarning(self, *args) -> "void":
        """_EnablePixelTypeSignedByteWarning(Band self, bool b)"""
...
class SubdatasetInfo(_object):
    """Proxy of C++ GDALSubdatasetInfoShadow class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SubdatasetInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SubdatasetInfo, name)
...
SubdatasetInfo_swigregister = _gdal.SubdatasetInfo_swigregister
SubdatasetInfo_swigregister(SubdatasetInfo)


def GetSubdatasetInfo(*args) -> "GDALSubdatasetInfoShadow *":
    """GetSubdatasetInfo(char const * pszFileName) -> GDALSubdatasetInfoShadow *"""
...
class Relationship(_object):
    ...
    def __init__(self, *args):
        """__init__(GDALRelationshipShadow self, char const * name, char const * leftTableName, char const * rightTableName, GDALRelationshipCardinality cardinality) -> Relationship"""
        this = _gdal.new_Relationship(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
Relationship_swigregister = _gdal.Relationship_swigregister
...
class SuggestedWarpOutputRes(_object):
    """Proxy of C++ SuggestedWarpOutputRes class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SuggestedWarpOutputRes, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SuggestedWarpOutputRes, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["width"] = _gdal.SuggestedWarpOutputRes_width_get
    if _newclass:
        width = _swig_property(_gdal.SuggestedWarpOutputRes_width_get)
    __swig_getmethods__["height"] = _gdal.SuggestedWarpOutputRes_height_get
    if _newclass:
        height = _swig_property(_gdal.SuggestedWarpOutputRes_height_get)
    __swig_getmethods__["xmin"] = _gdal.SuggestedWarpOutputRes_xmin_get
    if _newclass:
        xmin = _swig_property(_gdal.SuggestedWarpOutputRes_xmin_get)
    __swig_getmethods__["ymin"] = _gdal.SuggestedWarpOutputRes_ymin_get
    if _newclass:
        ymin = _swig_property(_gdal.SuggestedWarpOutputRes_ymin_get)
    __swig_getmethods__["xmax"] = _gdal.SuggestedWarpOutputRes_xmax_get
    if _newclass:
        xmax = _swig_property(_gdal.SuggestedWarpOutputRes_xmax_get)
    __swig_getmethods__["ymax"] = _gdal.SuggestedWarpOutputRes_ymax_get
    if _newclass:
        ymax = _swig_property(_gdal.SuggestedWarpOutputRes_ymax_get)
...
SuggestedWarpOutputRes_swigregister = _gdal.SuggestedWarpOutputRes_swigregister
SuggestedWarpOutputRes_swigregister(SuggestedWarpOutputRes)


def SuggestedWarpOutputFromTransformer(*args) -> "SuggestedWarpOutputRes *":
    """SuggestedWarpOutputFromTransformer(Dataset src, GDALTransformerInfoShadow transformer) -> SuggestedWarpOutputRes"""
    return _gdal.SuggestedWarpOutputFromTransformer(*args)

def SuggestedWarpOutputFromOptions(*args) -> "SuggestedWarpOutputRes *":
    """SuggestedWarpOutputFromOptions(Dataset src, char ** options) -> SuggestedWarpOutputRes"""
...
class GDALVectorInfoOptions(_object):
    """Proxy of C++ GDALVectorInfoOptions class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, GDALVectorInfoOptions, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, GDALVectorInfoOptions, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        """__init__(GDALVectorInfoOptions self, char ** options) -> GDALVectorInfoOptions"""
        this = _gdal.new_GDALVectorInfoOptions(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
GDALVectorInfoOptions_swigregister = _gdal.GDALVectorInfoOptions_swigregister
GDALVectorInfoOptions_swigregister(GDALVectorInfoOptions)


def VectorInfoInternal(*args) -> "retStringAndCPLFree *":
    """VectorInfoInternal(Dataset hDataset, GDALVectorInfoOptions infoOptions) -> retStringAndCPLFree *"""
...
class GDALFootprintOptions(_object):
    """Proxy of C++ GDALFootprintOptions class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, GDALFootprintOptions, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, GDALFootprintOptions, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        """__init__(GDALFootprintOptions self, char ** options) -> GDALFootprintOptions"""
        this = _gdal.new_GDALFootprintOptions(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
GDALFootprintOptions_swigregister = _gdal.GDALFootprintOptions_swigregister
GDALFootprintOptions_swigregister(GDALFootprintOptions)


def wrapper_GDALFootprintDestDS(*args) -> "int":
    """wrapper_GDALFootprintDestDS(Dataset dstDS, Dataset srcDS, GDALFootprintOptions options, GDALProgressFunc callback=0, void * callback_data=None) -> int"""
    return _gdal.wrapper_GDALFootprintDestDS(*args)

def wrapper_GDALFootprintDestName(*args) -> "GDALDatasetShadow *":
    """wrapper_GDALFootprintDestName(char const * dest, Dataset srcDS, GDALFootprintOptions options, GDALProgressFunc callback=0, void * callback_data=None) -> Dataset"""
